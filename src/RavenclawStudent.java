public class RavenclawStudent extends HogwartsStudent {
    ...
    public void compareRavenclaw(RavenclawStudent ravenclawStudent) {
        ...
        if (ability1 < ability2) {
            ...
            System.out.printf("Когтевранец %s лучше, чем Когтевранец %s: %d VS %d%n", ravenclawStudent.getName(),
                    getName(), ability2, ability1);
        } else {
            System.out.printf("Когтевранец %s такой же, как и Когтевранец %s: %d VS %d%n", ravenclawStudent.getName(),
