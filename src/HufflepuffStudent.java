public class HufflepuffStudent extends HogwartsStudent {
    ...
    public void compareHufflepuff(HufflepuffStudent hufflepuffStudent) {
        ...
        if (ability1 < ability2) {
            System.out.printf("Пуффендуец %s лучше, чем Пуффендуец %s: %d VS %d%n", getName(),
                    hufflepuffStudent.getName(), ability1, ability2);
        } else if (ability2 > ability1) {
            System.out.printf("Пуффендуец %s лучше, чем Пуффендуец %s: %d VS %d%n", hufflepuffStudent.getName(),
                    getName(), ability2, ability1);
        } else {
            System.out.printf("Пуффендуец %s такой же, как и Пуффендуец %s: %d VS %d%n", hufflepuffStudent.getName(),
